...
public class Circle extends Figure implements IGetArea {
	 ...
	 * @since 14.04.2014
	 * example CIRCLE; 4711; BUILDING 1; 7; 30; 50
	 */
	private void fill() throws ValidationException  {
		...
		try {
			...
			throw new ValidationException("Problem with format : "+Arrays.toString(getArr())+", "+e.getClass().getName());
	...
	public String  toString() {
		return "Circle [radius=" + radius + ", easting=" + easting
				+ ", northing=" + northing + ", getId()=" + getId()
